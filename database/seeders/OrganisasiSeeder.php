...
class OrganisasiSeeder extends Seeder
{
    public function run()
    {
        ...
        for ($i = 0; $i < 50; $i++) {
            DB::table('organisasi_gerejas')->insert([
                'pendeta' => $faker->name,
                'image_pendeta' => $image_profile,
                'guru_huria' => $faker->name,
                'image_guru_huria' => $image_profile,
                'biblevroh' => $faker->name,
                'image_biblevroh' => $image_profile,
                'bendahara_gereja' => $faker->name,
                'image_bendahara_gereja' => $image_profile,
                'sekretaris_gereja' => $faker->name,
                'image_sekretaris_gereja' => $image_profile,
