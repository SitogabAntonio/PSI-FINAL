...
<div>
    <div class="alert alert-secondary mx-4" role="alert">
        <span class="text-white">
            <strong>Super Admin berhak menghapus berita Suka Duka Cita</strong>
        </span>
    </div>
            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <h5 class="mb-0">Berita Suka / Duka Cita</h5>

                        <form action="/sukadukacita" class="d-flex align-items-center">
                            <div class="input-group mb-0">
                                <input type="text" class="form-control" placeholder="Cari Berita Suka / Duka Cita..."
                        ...
                        <a href="/sukadukacita/create" class="btn bg-gradient-primary btn-sm mb-0" type="button">+&nbsp;
                            Tambah Bertita Suka / Duka Cita</a>
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                @foreach($sukadukacita as $key => $item)
                                <tr>
                                    <td class="ps-4">
                                        <p class="text-xs font-weight-bold mb-0">{{ $sukadukacita->firstItem() + $key }}
                                        </p>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ url('/sukadukacita/detele', $item->id) }}"
                        ...
                        @if($sukadukacita->isEmpty())
                        <div style="margin-top: 50px;">
                            <p class="text-center mb-3">Tidak ada data Berita Suka-Duka Cita.</p>
                        </div>
                        @endif
                        <!-- Pagination -->
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Edit Berita Suka Duka Cita</h5>
                                    <button type="button" class="close" data-dismiss="modal"
                                        aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <form action="{{ url('/sukadukacita/update', $item->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="category" required>
                                                <option value="SUKA CITA" {{ $item->category == 'SUKA CITA' ? 'selected' : '' }}>SUKA CITA</option>
                                                <option value="DUKA CITA" {{ $item->category == 'DUKA CITA' ? 'selected' : '' }}>DUKA CITA</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="card border-success">
                                    <div class="card-header bg-info text-white" style="font-size: 23px;">
                                        <strong><i class="fa fa-database"></i> Berita {{ $data->category}}
                                            "{{ $data->judul }}"</strong>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <div class="slide"
                                                    data-thumb="{{asset('images/categoryproducts/' . $data->image)}}"><a
                                                        href="{{asset('images/categoryproducts/' . $data->image)}}"
                                                        title="Preview Dress - Front View"
                                                        data-lightbox="gallery-item"><img
                                                            src="{{asset('images/categoryproducts/' . $data->image)}}"
                                                            alt="{{$data->image}}" class="img-fluid img-thumbnail"></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
