...
<div>
    <div class="alert alert-secondary mx-4" role="alert">
        <span class="text-white">
            <strong>Super Admin berhak menghapus Sejarah Gereja</strong>
        </span>
    </div>
            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <h5 class="mb-0">Semua Sejarah Gereja</h5>

                        <form action="/sejarah/superadmin" class="d-flex align-items-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @if (!is_null($item->sejarah))
                                        <a href="javascript:void(0);" class="badge bg-secondary border-0" onclick='confirmDeleteURL("{{ $item->id }}")'>
                                            Hapus
                                        </a>
                                        @endif
                                    </td>
                        ...
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <strong style="font-size: 30px;">Sejarah Gereja</strong>
                                </div>
                                            ...
                                            <div class="col-12">
                                                <div class="table-responsive">
                                                    <table class="table cart">
                                                        ...
                                                        <tr>
                                                            <th><strong>Sejarah :</strong></th>
                                                            <td>
                                                                {{ optional($data->sejarah)->sejarah ?? 'Sejarah Gereja belum ditambahkan.' }}
                                                            </td>
                                                        </tr>
                                                        <tr></tr>
                                                    </table>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    Apakah Anda yakin ingin menghapus Sejarah Gereja ini?
                                </div>
                ...
                <script>
                    function confirmDeleteURL(itemId) {
                        $('#confirmDeleteModal').modal('show');
                        $('#deleteConfirmBtn').attr('onclick', 'deleteSejarah(' + itemId + ')');
                    }

                    function deleteSejarah(itemId) {
                        const url = '/sejarah/superadmin/delete/' + itemId;
